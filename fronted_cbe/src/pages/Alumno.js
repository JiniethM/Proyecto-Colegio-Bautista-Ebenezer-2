...
function Alumno() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!Nombres) {
      ...
      displayError("Nombres", "El nombre solo debe contener caracteres alfabéticos y espacios");
      return;
    }
    ...
    if (!Apellidos) {
      ...
      displayError("Apellidos", "El apellido debe tener como máximo 50 caracteres");
      return;
    } else if (!/^[a-zA-Z\s]+$/.test(Apellidos)) {
      displayError("Apellidos", "El apellido solo debe contener caracteres alfabéticos y espacios");
      return;
    }

    if (!Fecha_Nacimiento) {
      displayError("Fecha_Nacimiento", "El campo Fecha de Nacimiento es obligatorio");
      return;
    }
    ...
    if (!Telefono) {
      ...
      displayError("Telefono", "El formato de teléfono es inválido, debe ser ####-####");
      return;
    }
                ...
                <Col sm="6" md="6" lg="6">
                  <FloatingLabel controlId="Nombres" label="Nombre">
                    <Form.Control
                      ...
                      value={Nombres}
                      onChange={(e) => setNombres(e.target.value.replace(/[^a-zA-Z\s]/g, "").substring(0, 50))}
                ...
                <Col sm="6" md="6" lg="6">
                  <FloatingLabel controlId="Apellidos" label="Apellido">
                    <Form.Control
                      ...
                      value={Apellidos}
                      onChange={(e) => setApellidos(e.target.value.replace(/[^a-zA-Z\s]/g, "").substring(0, 50))}
                ...
                <Col sm="12" md="6" lg="6">
                  <FloatingLabel controlId="Telefono" label="Teléfono">
                    <Form.Control
                      ...
                      value={Telefono}
                      onChange={(e) => setTelefono(e.target.value.replace(/[^\d-]/g, '').replace(/(\d{4})\-?(\d{0,4})/, '$1-$2').substring(0, 9))}
