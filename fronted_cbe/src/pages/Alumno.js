...
import { buscarAlumnos } from '../ValidacionesCN/buscarAlumnos'; // Ajustar la ruta según tu estructura de proyecto
...
const AlumnoList = ({ handleAlumnoSelect }) => {
  ...
  const filteredAlumnos = buscarAlumnos(alumnos, searchQuery);
